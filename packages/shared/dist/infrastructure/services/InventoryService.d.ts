...
import { InventoryItem, InventoryItemCreateDto, InventoryItemUpdateDto, InventoryStats, ShoppingListItem, InventoryAlert, StorageLocation } from '../../core/models/inventory';
/**
...
export declare class InventoryService implements IInventoryService {
     ...
     */
    constructor(inventoryRepository: IInventoryRepository, recipeRepository: IRecipeRepository);
    /**
     ...
     */
    generateShoppingList(includeOutOfStock: boolean, includeLowStock: boolean): Promise<ShoppingListItem[]>;
    /**
     ...
     */
    sortItems(sortBy: 'name' | 'expirationDate' | 'quantity' | 'category' | 'location', ascending: boolean): Promise<InventoryItem[]>;
}
