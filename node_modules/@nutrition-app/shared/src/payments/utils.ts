 ...
 */
export function canBeRefunded(transaction: PaymentTransaction): boolean {
 ...
 */
export function getProviderConfig(provider: PaymentProvider, isProduction: boolean): Record<string, any> {
