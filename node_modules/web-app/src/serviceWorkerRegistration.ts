...
// Check if the service worker can be used in this browser
...
export function register(config?: Config) {
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
    ...
    // Don't register service worker if public URL is on a different origin
...
/**
 * Check if a service worker is valid and register it if it is
 * @param swUrl Service worker URL
 * @param config Configuration options
 */
